...
<div class="a4-paper">
    ...
    <table class="header-table">
        ...
        <tr>
            ...
            <td>: {{ $esertifikat->peserta_pkl->peserta->user->tempat_lahir }},
                {{ \Carbon\Carbon::parse($esertifikat->peserta_pkl->peserta->user->tanggal_lahir)->locale('id')->translatedFormat('d F Y') }}
            </td>
        </tr>
    </table>
    ...
    <table>
        ...
        <tbody>
            <tr>
                ...
                <td class="center">{{ $esertifikat->peserta_pkl->nilai_pkl->nilai_disiplin_kerja }}</td>
                <td class="center">{{ predikat($esertifikat->peserta_pkl->nilai_pkl->nilai_disiplin_kerja) }}</td>
            </tr>
            <tr>
                <td class="center">2</td>
                <td>Kemajuan Kerja dan Motivasi</td>
                <td class="center">{{ $esertifikat->peserta_pkl->nilai_pkl->nilai_kemajuan_kerja }}</td>
                <td class="center">{{ predikat($esertifikat->peserta_pkl->nilai_pkl->nilai_kemajuan_kerja) }}</td>
            </tr>
            <tr>
                <td class="center">3</td>
                <td>Kualitas Kerja</td>
                <td class="center">{{ $esertifikat->peserta_pkl->nilai_pkl->nilai_kualitas_kerja }}</td>
                <td class="center">{{ predikat($esertifikat->peserta_pkl->nilai_pkl->nilai_kualitas_kerja) }}</td>
            </tr>
            <tr>
                <td class="center">4</td>
                <td>Inisiatif dan Kreatifitas</td>
                <td class="center">{{ $esertifikat->peserta_pkl->nilai_pkl->nilai_inisiatif_kreatifitas }}</td>
                <td class="center">{{ predikat($esertifikat->peserta_pkl->nilai_pkl->nilai_inisiatif_kreatifitas) }}</td>
            </tr>
            <tr>
                <td class="center">5</td>
                <td>Perilaku / Sikap</td>
                <td class="center">{{ $esertifikat->peserta_pkl->nilai_pkl->nilai_perilaku }}</td>
                <td class="center">{{ predikat($esertifikat->peserta_pkl->nilai_pkl->nilai_perilaku) }}</td>
            </tr>
        </tbody>
    </table>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th colspan="2" style="background-color:#f5a700;">Nilai Perolehan</th>
            </tr>
            <tr>
                <th></th>
                <th></th>
        ...
        <tbody>
            <tr>
                ...
                <td class="center">{{ number_format($esertifikat->rata_rata, 0) }}</td>
                <td class="center">{{ predikat($esertifikat->rata_rata) }}</td>
            </tr>
            <tr>
                <td class="center">2</td>
                <td>Nilai sidang laporan PKL</td>
                <td class="center">{{ $esertifikat->peserta_pkl->nilai_pkl->nilai_sidang_pkl }}</td>
                <td class="center">{{ predikat($esertifikat->peserta_pkl->nilai_pkl->nilai_sidang_pkl) }}</td>
            </tr>
            <tr>
                <td colspan="2" class="bold" style="text-align:right;">Nilai Akhir :</td>
                <td colspan="2" class="center bold">{{ number_format($esertifikat->nilai_akhir, 0) }}</td>
            </tr>
            <tr>
                <td colspan="2" class="bold" style="text-align:right;">Predikat :</td>
                <td colspan="2" class="center bold">{{ predikat($esertifikat->nilai_akhir) }}</td>
            </tr>
            <tr>
